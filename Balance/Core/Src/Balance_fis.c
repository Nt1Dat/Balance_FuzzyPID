...
/* Generated : 26-Apr-2023 11:03:09 */
...
static const float e_NB_p[] = { -1.7500f, -1.0830f, -0.4000f, -0.2500f };
static const float e_ZE_p[] = { -0.1500f, 0.0000f, 0.1500f };
static const float e_PB_p[] = { 0.2500f, 0.4000f, 1.0800f, 1.7500f };
static const float e_NS_p[] = { -0.4000f, -0.2500f, -0.1500f, -0.0000f };
static const float e_PS_p[] = { 0.0000f, 0.1500f, 0.2500f, 0.4000f };

static const float edot_NB_p[] = { -10.0000f, -1.0000f, -0.2500f };
static const float edot_ZE_p[] = { -0.2500f, 0.0000f, 0.2500f };
static const float edot_PB_p[] = { 0.2500f, 1.0000f, 10.0000f };
static const float edot_NS_p[] = { -0.6000f, -0.2500f, 0.0000f };
static const float edot_PS_p[] = { 0.0000f, 0.2500f, 0.6000f };

static const float u_NB_p[] = { -1.0000f };
static const float u_NM_p[] = { -0.4500f };
